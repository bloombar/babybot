...
class WatsonSession {
  ...
  updateExpiration() {
    ...
    this.expiration =
      ...
      parseInt(process.env.ASSISTANT_SESSION_TIMEOUT_SECONDS) // 5 minutes in the future
  ...
  return new Promise((resolve, reject) => {
    ...
    assistant
      ...
      .then((res) => {
        ...
        let intent = responseBody.intents.length
          ? responseBody.intents[0].intent
          : ''
        ...
        if (
          responseBody.intents.length > 0 &&
          responseBody.intents &&
          responseBody.intents[0].intent == 'get_grade'
        ) {
          //TO DO
